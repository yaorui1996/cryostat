...
class IonGauge:
    ...
    def __init__(self, serial_number:str, baudrate=9600) -> None:
        self.__ser = serial.Serial(port=find_com_name(serial_number), baudrate=baudrate)
    ...
    def query(self, cmd:str) -> str:
        ...
        recv = self.__ser.read(1024).decode()
